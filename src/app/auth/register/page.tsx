...
export default function RegisterPage() {
  ...
  const handleOAuthRegister = async (provider: 'google' | 'microsoft' | 'apple') => {
    setError('');
    try {
      await loginWithOAuth(provider);
    } catch (err) {
      setError(err instanceof Error ? err.message : 'OAuth registration failed. Please try again.');
    }
  };
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-start">
                ...
                />
                <label htmlFor="terms-and-conditions" className="ml-2 text-sm text-gray-600">
                  I agree to the{' '}
